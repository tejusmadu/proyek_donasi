...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <img src="{{ asset('image/berbagi1.jpg') }}" class="d-block w-20" style="max-width: 50%; height: auto; margin-bottom: 20px;">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <h2>Dokumentasi</h2>
            <ul class="list-group">
                <li class="list-group-item"><a href="esports.html">Berbagi Makanan</a></li>
                <li class="list-group-item"><a href="bazar">Bazar</a></li>
                <li class="list-group-item"><a href="#">Santunan</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <img src="image/berbagi2.jpg" alt="Gambar Artikel 1" class="card-img-top" style="max-width: 50%; height: auto; margin-bottom: 20px;">
                <div class="card-body">
                    <h5 class="card-title">Berbagi Makanan</h5>
                    <p class="card-text"></p>
                </div>
