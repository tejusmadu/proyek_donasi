...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <img src="{{ asset('image/santunan1.JPG') }}" class="d-block w-20" style="max-width: 50%; height: auto; margin-bottom: 20px;">
                <div class="card-body">
                    <h5 class="card-title">Santunan</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>        
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <img src="image/santunan3.JPG" alt="Gambar Artikel 1" class="card-img-top" style="max-width: 50%; height: auto; margin-bottom: 20px;">
                <div class="card-body">
                    <h5 class="card-title">Santunan</h5>
                    <p class="card-text"></p>
                </div>
